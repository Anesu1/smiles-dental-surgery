                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="space-y-6">
                        <Link href="/" className="flex items-center space-x-2">
                            <Image src="/images/logo-1.png" alt="Logo" width={100} height={50} className="w-30 h-auto" />
                        </Link>
                    ...
                    <div>
                        ...
                        <ul className="space-y-6">
                            <li className="flex items-start gap-3 text-dental-200">
                                ...
                                <span>ZimPost suite 78c . Joshua Mqabuko Nkomo street between 7th and 8th avenue (opposite fazak )</span>
                            </li>
